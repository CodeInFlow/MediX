...
public class Login extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v1 = inflater.inflate(R.layout.frag_otp, container, false);

        mobile = (EditText) v.findViewById(R.id.et_phnNos);
        ...
        getOtp = v.findViewById(R.id.btn_getOtp);
    ...
    public void showBottomSheetDialog() {
        ...
        bottomSheetDialog.setContentView(R.layout.frag_otp);
        bottomSheetDialog.show();
        bottomSheetDialog.setCancelable(false);
        bottomSheetDialog.setCanceledOnTouchOutside(false);

        login = bottomSheetDialog.findViewById(R.id.btn_login);
        otp = bottomSheetDialog.findViewById(R.id.et_otp);
